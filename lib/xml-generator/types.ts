...
export type EnergyPriceIndex = 
  | "01" | "02" | "03" | "04" | "05" | "06" | "07" // Quarterly: PUN, TTF, PSV, Psbil, PE, Cmem, Pfor
  | "08" | "09" | "10" | "11" // Bimonthly: PUN, TTF, PSV, Psbil
  | "12" | "13" | "14" | "15" // Monthly: PUN, TTF, PSV, Psbil
  | "99"; // Other

// Regulated components
export type RegulatedComponentCode = 
  | "01" | "02" // Electricity: PCV, PPE
  | "03" | "04" | "05" | "06" | "07" | "09" | "10"; // Gas: CCR, CPR, GRAD, QTint, QTpsv, QVD_fissa, QVD_Variabile

// Time band types
export type TimeBandType = "01" | "02" | "03" | "04" | "05" | "06" | "07" | "91" | "92" | "93";
...
export type ComponentTimeBand = "01" | "02" | "03" | "04" | "05" | "06" | "07" | "08" | "91" | "92" | "93";
// 01: Monorario/F1, 02: F2, 03: F3, 04: F4, 05: F5, 06: F6, 07: Peak, 08: OffPeak, 91: F2+F3, 92: F1+F3, 93: F1+F2

// Dispatching types
export type DispatchingType = "01" | "02" | "03" | "04" | "05" | "06" | "07" | "08" | "09" | "10" | "11" | "12" | "13" | "99";
...
export type ComponentBandCode = 
  | "01" | "02" | "03" | "04" | "05" | "06" | "07" | "09" | "10" // Components: PCV to QVD_Variabile
  | "11" | "12" | "13" | "14" | "15" | "16" // Bands: F1 to F6
  | "17" | "18" // Peak, OffPeak
  | "91" | "92" | "93"; // F2+F3, F1+F3, F1+F2
...
// Validity months
export type ValidityMonth = "01" | "02" | "03" | "04" | "05" | "06" | "07" | "08" | "09" | "10" | "11" | "12";
...
export type ConditionallyRequired<T, Condition> = Condition extends true ? T : T | undefined;
